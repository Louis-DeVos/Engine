...
void Game::LoadGame() const
{
	...
	//std::shared_ptr<dae::GameObject> go = std::make_shared<GameObject>(scene);
	...
	//ugg->getComponent<PurpleEnemyComponent>().lock()->SetLocation(node.lock()->GetLastConnection(Position::BottomRight));
