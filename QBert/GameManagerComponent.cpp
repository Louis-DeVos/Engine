...
GameManagerComponent::GameManagerComponent(std::weak_ptr<GameObject> pGameObject)
	:m_pGameObject{pGameObject}
{
	...
	render->SetTexture(ResourceManager::GetInstance().LoadTexture("background.jpg"));
	go->AddComponent(render);
	scene.lock()->Add(go);

	go = std::make_shared<GameObject>(scene);
	render = std::make_shared<RenderComponent>(std::weak_ptr<GameObject>(go));
	render->SetTexture(ResourceManager::GetInstance().LoadTexture("logo.png"));
	go->AddComponent(render);
	...
	std::shared_ptr<GameObject> fps = std::make_shared<GameObject>(scene);
	fps->AddComponent(std::make_shared<FPSComponent>(std::weak_ptr<GameObject>(fps)));
	fps->AddComponent(std::make_shared<TextComponent>(" ", ResourceManager::GetInstance().LoadFont("Lingua.otf", 12), std::weak_ptr<GameObject>(fps)));
	...
	std::shared_ptr<GameObject> lifeCounter = std::make_shared<GameObject>(scene);
	lifeCounter->AddComponent(std::make_shared<LifeComponent>(std::weak_ptr<GameObject>(lifeCounter)));
	lifeCounter->AddComponent(std::make_shared<TextComponent>(" ", ResourceManager::GetInstance().LoadFont("Lingua.otf", 12), std::weak_ptr<GameObject>(lifeCounter)));
	...
	std::shared_ptr<GameObject> lifeCounter2 = std::make_shared<GameObject>(scene);
	lifeCounter2->AddComponent(std::make_shared<LifeComponent>(std::weak_ptr<GameObject>(lifeCounter2)));
	lifeCounter2->AddComponent(std::make_shared<TextComponent>(" ", ResourceManager::GetInstance().LoadFont("Lingua.otf", 12), std::weak_ptr<GameObject>(lifeCounter2)));
	...
	std::shared_ptr<GameObject> scoreCounter = std::make_shared<GameObject>(scene);
	scoreCounter->AddComponent(std::make_shared<ScoreComponent>(std::weak_ptr<GameObject>(scoreCounter)));
	scoreCounter->AddComponent(std::make_shared<TextComponent>(" ", ResourceManager::GetInstance().LoadFont("Lingua.otf", 12), std::weak_ptr<GameObject>(scoreCounter)));
...
void GameManagerComponent::Update(float dt)
{
	...
	if (m_pMenu.expired())
	{
		std::shared_ptr<GameObject> menuObject = std::make_shared<GameObject>(m_pGameObject.lock()->GetScene());
		std::shared_ptr<MenuComponent> menuComponent = std::make_shared<MenuComponent>(std::weak_ptr<GameObject>(menuObject), m_pGameObject.lock()->getComponent<GameManagerComponent>());
...
void GameManagerComponent::SpawnCoily()
{
	...
	std::shared_ptr<GameObject> Coily = std::make_shared<GameObject>(scene);
	Coily->AddComponent(std::make_shared<CoilyComponent>(Coily));
	auto render = std::make_shared<RenderComponent>(std::weak_ptr<GameObject>(Coily));
	render->SetTexture(ResourceManager::GetInstance().LoadTexture("Egg.png"));
	...
	if (m_Versus)
	{
		...
		InputManager::GetInstance().AddKeyboardCommand(new CoilyMoveCommand{ m_pCoily, Direction::TopLeft }, SDLK_i, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new CoilyMoveCommand{ m_pCoily, Direction::TopRight }, SDLK_o, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new CoilyMoveCommand{ m_pCoily, Direction::BottomLeft }, SDLK_k, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new CoilyMoveCommand{ m_pCoily, Direction::BottomRight }, SDLK_l, SDL_KEYDOWN);


		InputManager::GetInstance().AddControllerCommand(new CoilyMoveCommand{ m_pCoily, Direction::TopLeft }, VK_PAD_X, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new CoilyMoveCommand{ m_pCoily, Direction::TopRight }, VK_PAD_Y, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new CoilyMoveCommand{ m_pCoily, Direction::BottomLeft }, VK_PAD_A, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new CoilyMoveCommand{ m_pCoily, Direction::BottomRight }, VK_PAD_B, XINPUT_KEYSTROKE_KEYDOWN);
	}
}
...
void GameManagerComponent::SpawnPurpleEnemy()
{
	...
	std::shared_ptr<GameObject> purpleEnemy = std::make_shared<GameObject>(scene);
	purpleEnemy->AddComponent(std::make_shared<PurpleEnemyComponent>(purpleEnemy, (randomNum == 0) ? -1 : 1));
	auto render = std::make_shared<RenderComponent>(std::weak_ptr<GameObject>(purpleEnemy));
	render->SetTexture(ResourceManager::GetInstance().LoadTexture((randomNum == 0) ? "Ugg.png" : "Wrongway.png"));
...
void GameManagerComponent::SpawnGreenEnemy()
{
	...
	std::shared_ptr<GameObject> greenEnemy = std::make_shared<GameObject>(scene);
	greenEnemy->AddComponent(std::make_shared<GreenEnemyComponent>(greenEnemy));
	auto render = std::make_shared<RenderComponent>(std::weak_ptr<GameObject>(greenEnemy));
	render->SetTexture(ResourceManager::GetInstance().LoadTexture((rand() % 2 == 0) ? "Slick.png" : "Sam.png"));
...
void GameManagerComponent::LoadLevel( )
{
	...
	std::shared_ptr<GameObject> QBert = std::make_shared<GameObject>(scene);
	...
	auto render = std::make_shared<RenderComponent>(std::weak_ptr<GameObject>(QBert));
	render->SetTexture(ResourceManager::GetInstance().LoadTexture("QBert.png"));
	...
	InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::TopLeft }, SDLK_q, SDL_KEYDOWN);
	InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::TopRight }, SDLK_w, SDL_KEYDOWN);
	InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::BottomLeft }, SDLK_a, SDL_KEYDOWN);
	InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::BottomRight }, SDLK_s, SDL_KEYDOWN);


	InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::TopLeft }, VK_PAD_DPAD_LEFT, XINPUT_KEYSTROKE_KEYDOWN);
	InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::TopRight }, VK_GAMEPAD_DPAD_UP, XINPUT_KEYSTROKE_KEYDOWN);
	InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::BottomLeft }, VK_PAD_DPAD_DOWN, XINPUT_KEYSTROKE_KEYDOWN);
	InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert->getComponent<QBertComponent>(), Direction::BottomRight }, VK_PAD_DPAD_RIGHT, XINPUT_KEYSTROKE_KEYDOWN);


	if (m_Coop)
	{

		std::shared_ptr<GameObject> QBert2 = std::make_shared<GameObject>(scene);
		...
		InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::TopLeft }, SDLK_i, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::TopRight }, SDLK_o, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::BottomLeft }, SDLK_k, SDL_KEYDOWN);
		InputManager::GetInstance().AddKeyboardCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::BottomRight }, SDLK_l, SDL_KEYDOWN);


		InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::TopLeft }, VK_PAD_X, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::TopRight }, VK_GAMEPAD_Y, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::BottomLeft }, VK_PAD_A, XINPUT_KEYSTROKE_KEYDOWN);
		InputManager::GetInstance().AddControllerCommand(new MoveCommand{ QBert2->getComponent<QBertComponent>(), Direction::BottomRight }, VK_PAD_B, XINPUT_KEYSTROKE_KEYDOWN);
